...
## What do you need?
You'll need Python 3, Pygame (which can be installed using pip or pip3), and Click (also installable via pip or pip3). If we've forgotten anything, please let us know.# Scala_search
# Scala_search
# Scala_search
